                            ...
                            <?php foreach ($users as $user) : ?>
                                <tr class="shadow-sm ">
                                    ...
                                    <td class="actions w-30 ">
                                        <a href="<?= $this->Url->build(['controller' => 'users', 'action' => 'edit', $user->token]) ?>" type="button" class=" p-1 text-muted">อัพเดต</a>
                                        <a href="<?= $this->Url->build(['controller' => 'users', 'action' => 'view', $user->token]) ?>" class="p-1 text-primary">ดูข้อมูล</a>
                                    </td>
                                </tr>
                            <?php endforeach ?>
